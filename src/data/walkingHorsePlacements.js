/** Параметры одной лошадки в каждой секции главной (разные задержки и направления) */
export const WALKING_HORSE_BY_SECTION = {
  hero: { top: '68%', size: 30, duration: 36, delay: -22, reverse: false },
  features: { top: '42%', size: 26, duration: 42, delay: -8, reverse: true },
